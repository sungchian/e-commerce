      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center space-y-4">
          <h1 class="text-4xl sm:text-5xl font-bold text-gray-900">
            American Snacks Collection
          </h1>
          <p class="text-lg text-gray-600 max-w-2xl mx-auto">
            Taste the best flavors from across America. From classic candies to unique treats, discover snacks that bring joy to every bite.
          </p>
        </div>
      </div>
    </section>
...
// Mock American snacks products data
const snackProducts = [
  {
    id: 1,
    ...
    badge: "Bestseller",
    category: "candy",
    description: "Classic peanut butter and chocolate combination."
  },
  {
    id: 2,
    name: "Twinkies Golden Sponge Cake",
    price: 3.99,
    image: americanSnacks,
    badge: "Popular",
    category: "snacks",
    description: "America's favorite snack cake with creamy filling."
  },
  {
    id: 3,
    ...
    image: americanSnacks,
    category: "cookies",
    description: "The world's favorite cookie with chocolate and cream."
  },
  {
    id: 4,
    ...
    category: "breakfast",
    description: "Toaster pastries with sweet strawberry filling."
  },
  {
    id: 5,
  ...
  },
  {
    ...
    image: americanSnacks,
    category: "candy",
    description: "Caramel, nougat, and peanuts covered in chocolate."
  }
]
...
const filteredProducts = computed(() => {
  return selectedCategory.value === "all" 
    ? snackProducts 
    : snackProducts.filter(product => product.category === selectedCategory.value)
})
</script>
